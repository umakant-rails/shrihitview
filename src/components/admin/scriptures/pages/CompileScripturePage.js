...
import {deleteScrArticle, getScrArticles } from '../../../../slices/admin/adminScriptureSlice';
import Pagination from '../../../shared/Pagination';;


const CompileScripturePage = () => {
  const {id} = useParams();
                        ...
                        <td className="px-2 py-3">
                          <div className='overflow-hidden'>
                            <Link to={`/articles/${article.id}`} className="text-blue-600" target="_blank">
                              {<div dangerouslySetInnerHTML={{__html: article.hindi_title}} />}
                            </Link>
                          </div>
                        </td>
                        <td className="px-2 py-3">
...
export default CompileScripturePage;