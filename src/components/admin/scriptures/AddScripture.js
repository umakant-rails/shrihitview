...
const AddScripture = () => {
  ...
  const { scripture, scripture_types, authors } = useSelector( (state) => state.adminScripture)
  ...
  useEffect( () => {
    if(scripture){resetForm();/*navigate('/articles/new');*/ } 
  }, [scripture]);
      ...
      <div className='col-start-2 col-span-10 shadow-2xl bg-white border border-gray-200 px-10 pt-5'>
        ...
        <form className="py-5 px-10" onSubmit={onStrotaSubmit}>
          <div className='grid md:grid-cols-12 gap-6 mb-3'>
            ...
            <div className='col-span-6'>
              <label className="block mb-2 font-medium text-gray-900 dark:text-white">
                लेखक <span title="required" className="text-red-600 font-bold">*</span>
              </label>
