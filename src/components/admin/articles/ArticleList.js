...
import { getArticles } from '../../../actions/admin/admin_articles';
...
const ArticleList = () => {
  ...
  const { article_types, raags, contexts, authors, tags, scriptures, articles, total_articles } = useSelector( state => state.adminArticle );
          ...
          <tbody>
            ...
            className="border-b dark:border-gray-700 text-blue-500 cursor-pointer" >
              ...
              <td className="px-2 py-3 flex items-center justify-end">
                <Link to={`/articles/${article.id}`}>
                  <svg class="w-[30px] h-[30px] text-blue-500 dark:text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <svg class="w-[30px] h-[30px] text-red-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
