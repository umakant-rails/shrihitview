...
const UserPanchangShow = () => {
  ...
  useEffect( () => { currentMonth(); }, []);
	useEffect( () => { if(tithis) createTithisHash(tithis); }, [tithis]);
	...
	return (
      ...
      <div className='col-start-2 col-span-10 shadow-2xl bg-white border border-gray-200 px-10 pt-5 pb-8'>
          ...
          पंचांग - {panchang && panchang.title}
        </div>
				<header className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none">
					...
					<div className="flex items-center">
						...
						<div className="hidden md:ml-4 md:flex md:items-center">
							<button type="button" className={`ml-6 rounded-md bg-red-600 px-3 py-2 text-sm 
...
export default UserPanchangShow;