					...
					<div className='col-span-8'>
						<header className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none">
							<h1 className="text-xl font-semibold leading-6 text-red-700">
								<time dateTime="2022-01">{ENG_MONTH[currentDate.format('M')-1]} {currentDate.format('YYYY')}</time>
							</h1>
					...
					<div className='col-span-4'>
						<header className="pt-4 pb-3">
							{tithisHash[dateFormat(moment().clone())] && <div className='grid md:grid-cols-12'>
									<div className={`col-span-12 border shadow-xl shadow-gray-300 border-pink-300 rounded 
										px-5 py-2 bg-pink-100 text-pink-600 font-bold text-center`}>
						...
						<div className="overflow-y-auto" style={{height: '640px'}}>
