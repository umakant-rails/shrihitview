...
export const USER_REGISTRATION= "USER_EGISTRATION";
export const USER_LOGIN = "USER_LOGIN";
export const USER_LOGOUT= "USER_LOGOUT";
export const PASSWORD_TOKEN_SENT = "PASSWORD_TOKEN_SENT";
export const PASSWORD_TOKEN_VARIFIED = "PASSWORD_TOKEN_VARIFIED";
export const PASSWORD_UPDATED_BY_TOKEN  = "PASSWORD_UPDATED_BY_TOKEN";
export const USER_ACCOUNT_CONFIRMED = "USER_ACCOUNT_CONFIRMED";
...
export const PANCHANG_TITHI_NEW = "PANCHANG_TITHI_NEW";
export const PANCHANG_TITHI_CREATED = "PANCHANG_TITHI_CREATED";
export const PANCHANG_TITHI_EDITING_DATA = "PANCHANG_TITHI_EDITING_DATA";
export const PANCHANG_TITHI_UPDATED = "PANCHANG_TITHI_UPDATED";
...
export const PB_SUGGESTION_LIST = "PB_SUGGESTION_LIST";
export const PB_SUGGESTION_SHOW = "PB_SUGGESTION_SHOW";
export const PB_SUGGESTION_CREATED = "PB_SUGGESTION_CREATED";